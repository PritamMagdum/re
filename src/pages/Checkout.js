            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
                <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                            ...
                            <div className="space-y-12">
                                <div className="border-b border-gray-900/10 pb-12">
                                    ...
                                    <div className="mt-6 flex items-center justify-end gap-x-4">
                                        <button type="button" className="rounded-md bg-gray-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                            Reset
                                        </button>
                                        <button
                                            type="submit"
                                ...
                                <div className="border-b border-gray-900/10 pb-12">
                                    ...
                                    <ul role="list" className="divide-y divide-gray-100">
                                        {addresses.map((address) => (
                                            <li key={address.email} className="flex justify-between gap-x-6 py-5 border-2 px-2 border-gray-200 rounded-md my-1">
                                                <div className="flex min-w-0 gap-x-4">
                                                    ...
                                                    <div className="min-w-0 flex-auto">
                                                        ...
                                                        <p className="mt-1 truncate text-xs leading-5 text-gray-500">{address.street} - {address.pincode}</p>
                    ...
                    <div className="lg:col-span-2">
                        <div className="mx-auto max-w-7xl px-0 bg-white sm:px-0 lg:px-0">
